...
CREATE TABLE `attendees` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_attendees_gevent` (`eventid`),
  CONSTRAINT `fk_attendees_gevent` FOREIGN KEY (`eventid`) REFERENCES `gevent` (`eventid`) ON DELETE CASCADE
...
-- Dump completed on 2021-07-23  4:11:50
