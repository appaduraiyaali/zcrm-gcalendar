...
CREATE TABLE `calendarconfig` (
  ...
  UNIQUE KEY `GCalId` (`gcalid`),
  KEY `userid` (`userid`),
  CONSTRAINT `fk_calendarconfig_calendaruser` FOREIGN KEY (`userid`) REFERENCES `calendaruser` (`userid`) ON DELETE CASCADE
...
-- Dump completed on 2021-07-23  4:12:14
